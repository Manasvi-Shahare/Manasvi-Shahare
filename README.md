...
I recently graduated with a Master's in Computer Science from University of California, Riverside.
...
►Languages: Java, Python, React, SQL, JavaScript, C, HTML, PHP
►Databases: MySQL,PostgreSQL, ElasticSearch
►Technologies: Shell Scripting, Spring Boot, MySQL, React.js, RESTful APIs, Angular, JUnit, Mockito 
►Tools: VSCode, Eclipse, Git, Docker, Kubernetes, Jira, Confluence, Maven, Intellij, Postman, Swagger, .NET
